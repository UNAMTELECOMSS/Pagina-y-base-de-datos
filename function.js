        ...
        alert(u);
            ...
            if( p1 == p2 ){
                if (p1!=false && p2 !=false){
                    var long=p1.length;
                    if(long>8){
                                respuesta="Datos correctos. Da click en Continuar";
                                alert(respuesta);
                        ...
                        location.href="./Registro.jsp?names="+n+"&nc="+nc+"&lastname="+ap+"&lastname2="+am+"&email="+mail+"&cel="+cel+"&tel="+tel+"&semestre="+sem+"&avance_cred="+av+"&opcion_titulacion="+opt+"&dependencia="+dep+""
                    }
